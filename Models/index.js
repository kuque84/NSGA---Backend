...
db.Previa.belongsTo(db.CicloLectivo, {
  foreignKey: "id_ciclo",
  as: "CicloLectivo",
});

db.Condicion.hasMany(db.Previa, { foreignKey: "id_condicion", as: "Previa" });
db.Previa.belongsTo(db.Condicion, {
...
db.Calificacion.hasMany(db.Previa, {
  foreignKey: "id_calificacion",
  as: "Previa",
});
db.Previa.belongsTo(db.Calificacion, {
  foreignKey: "id_calificacion",
  as: "Calificacion",
});
...
db.CicloLectivo.hasMany(db.TurnoExamen, {
  foreignKey: "id_ciclo",
  as: "TurnoExamen",
});
db.TurnoExamen.belongsTo(db.CicloLectivo, {
  foreignKey: "id_ciclo",
  as: "CicloLectivo",
});

db.TurnoExamen.hasMany(db.FechaExamen, {
  foreignKey: "id_turno",
  as: "FechaExamen",
});
db.FechaExamen.belongsTo(db.TurnoExamen, {
  foreignKey: "id_turno",
  as: "TurnoExamen",
});

db.Materia.hasMany(db.FechaExamen, {
  foreignKey: "id_materia",
  as: "FechaExamen",
});
db.FechaExamen.belongsTo(db.Materia, {
  foreignKey: "id_materia",
  as: "Materia",
});

db.Condicion.hasMany(db.FechaExamen, {
  foreignKey: "id_condicion",
  as: "FechaExamen",
});
db.FechaExamen.belongsTo(db.Condicion, {
  foreignKey: "id_condicion",
  as: "Condicion",
});
...
db.FechaExamen.hasMany(db.Inscripcion, {
  foreignKey: "id_fechaExamen",
  as: "Inscripcion",
});
db.Inscripcion.belongsTo(db.FechaExamen, {
  foreignKey: "id_fechaExamen",
  as: "FechaExamen",
});

db.Calificacion.hasMany(db.Inscripcion, {
  foreignKey: "id_calificacion",
  as: "Inscripcion",
});
db.Inscripcion.belongsTo(db.Calificacion, {
  foreignKey: "id_calificacion",
  as: "Calificacion",
});

db.TurnoExamen.hasMany(db.Inscripcion, {
  foreignKey: "id_turno",
  as: "Inscripcion",
});
db.Inscripcion.belongsTo(db.TurnoExamen, {
  foreignKey: "id_turno",
  as: "TurnoExamen",
});
...
db.Alumno.hasMany(db.InscripcionCurso, {
  foreignKey: "id_alumno",
  as: "InscripcionCurso",
});
db.InscripcionCurso.belongsTo(db.Alumno, {
  foreignKey: "id_alumno",
  as: "Alumno",
});

db.CicloLectivo.hasMany(db.InscripcionCurso, {
  foreignKey: "id_ciclo",
  as: "InscripcionCurso",
});
db.InscripcionCurso.belongsTo(db.CicloLectivo, {
  foreignKey: "id_ciclo",
  as: "CicloLectivo",
});

db.Plan.hasMany(db.InscripcionCurso, {
  foreignKey: "id_plan",
  as: "InscripcionCurso",
});
...
db.Division.hasMany(db.InscripcionCurso, {
  foreignKey: "id_division",
  as: "InscripcionCurso",
});
db.InscripcionCurso.belongsTo(db.Division, {
  foreignKey: "id_division",
  as: "Division",
});
